# Advanced Kubernetes Concepts: A Deep Dive
...
The process of how a pod connects to a service using DNS names:
...
### Kafka (Strimzi/Red Hat AMQ Streams)
...
## Practical Commands for Observation
